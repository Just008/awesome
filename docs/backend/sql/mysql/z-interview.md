...
> 总共参考了如下几个地址：
>
> [去 BAT 面试，总结了这 55 道 MySQL 面试题！](https://mp.weixin.qq.com/s/nHuIe0k6muEX4y9YBII7Dg)

## 1、基础问题

一张表，里面有ID自增主键，当insert了17条记录之后，删除了第15,16,17条记录，再把Mysql重启，再insert一条记录，这条记录的ID是18还是15 ？

![img](http://md.laragh.top/vuepress/mysql/interview/base-1.png)
...
![img](http://md.laragh.top/vuepress/mysql/interview/base-2.png)
![img](http://md.laragh.top/vuepress/mysql/interview/base-3.png)
...
![img](http://md.laragh.top/vuepress/mysql/interview/base-4.png)
